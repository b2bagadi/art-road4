      ...
      >
        ...
        <div className="container relative z-10 text-center space-y-8 py-20">
          <motion.h1
            ...
            className="text-5xl md:text-7xl font-bold leading-tight text-foreground dark:text-white drop-shadow-[0_4px_12px_rgba(0,0,0,0.9)]"
          >
            {t("home.hero.title")}
          ...
          <motion.p
            ...
            className="text-xl md:text-2xl text-foreground dark:text-white max-w-3xl mx-auto drop-shadow-[0_3px_10px_rgba(0,0,0,0.9)]"
          >
