...
export default function AdminDashboardPage() {
  ...
  const [activeTab, setActiveTab] = useState<"overview" | "services" | "gallery" | "leads" | "contact" | "about" | "companies" | "security">("overview");
          ...
          <div className="flex items-center gap-3">
            {logoLoading ? (
              ...
              <Link href="/" className="hover:opacity-80 transition-opacity">
                <img src={logoUrl} alt="Logo" className="h-10 w-auto object-contain cursor-pointer" />
              </Link>
            ) : (
      ...
      <main className="container py-8">
        ...
        <div className="flex gap-2 mb-8 border-b border-gray-800 overflow-x-auto">
          <button
            ...
            className={`px-6 py-3 text-sm font-medium transition-colors border-b-2 whitespace-nowrap ${activeTab === "overview"
          ...
          <button
            ...
            className={`px-6 py-3 text-sm font-medium transition-colors border-b-2 whitespace-nowrap ${activeTab === "gallery"
          ...
          <button
            ...
            className={`px-6 py-3 text-sm font-medium transition-colors border-b-2 whitespace-nowrap ${activeTab === "leads"
          ...
          <button
            ...
            className={`px-6 py-3 text-sm font-medium transition-colors border-b-2 whitespace-nowrap ${activeTab === "about"
          ...
          <button
            ...
            className={`px-6 py-3 text-sm font-medium transition-colors border-b-2 whitespace-nowrap ${activeTab === "companies"
          ...
          <button
            ...
            className={`px-6 py-3 text-sm font-medium transition-colors border-b-2 whitespace-nowrap ${activeTab === "security"
          ...
          <div>
            <div className="flex justify-between items-center mb-6">
              ...
              <button
                ...
                className="flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-lg hover:from-purple-700 hover:to-pink-700 transition-all shadow-lg hover:shadow-xl font-medium"
              >
                <Plus size={20} />
                Add Service
              </button>
          ...
          <div>
            ...
            {contactLoading ? (
              ...
              <div className="max-w-4xl">
                {contactNotice && (
                  <div
                    className={`${contactNotice.type === "success"
        ...
        {activeTab === "about" && (
          <div>
            ...
            <div className="max-w-4xl">
              {aboutNotice && (
                <div
                  className={`${aboutNotice.type === "success"
                    ? "bg-green-900/30 border-green-700 text-green-200"
                    : "bg-red-900/30 border-red-700 text-red-200"
                    } border rounded-lg p-3 mb-4`}
                >
        ...
        {activeTab === "security" && (
          <div>
            <div className="mb-6">
              ...
              <p className="text-gray-400">Change your admin username and password</p>
            </div>

            <div className="max-w-2xl">
              {securityNotice && (
                <div
                  className={`${securityNotice.type === "success"
                    ? "bg-green-900/30 border-green-700 text-green-200"
                    : "bg-red-900/30 border-red-700 text-red-200"
                    } border rounded-lg p-3 mb-4`}
                >
              ...
              <div className="bg-gray-800 border border-gray-700 rounded-lg p-8 space-y-6">
                ...
                <button
                  onClick={async () => {
                    ...
                    if (!securityForm.currentPassword) {
                      setSecurityNotice({ type: "error", message: "Current password is required" });
                    ...
                    if (!securityForm.newUsername && !securityForm.newPassword) {
                      setSecurityNotice({ type: "error", message: "Please provide a new username or password" });
                      setTimeout(() => setSecurityNotice(null), 4000);
                      return;
                    }
                    ...
                    try {
                      ...
                      if (res.ok) {
                        setSecurityNotice({ type: "success", message: "Credentials updated successfully. Please log in again." });
                        // Clear form
                        setSecurityForm({
                          currentPassword: "",
                          newUsername: "",
                        ...
                        setSecurityNotice({ type: "error", message: error || "Failed to update credentials" });
                      }
                    } catch (error) {
                      console.error("Failed to update security:", error);
                      setSecurityNotice({ type: "error", message: "Failed to update credentials. Please try again." });
                    } finally {
                ...
                <p className="text-sm text-gray-500 mt-2">
                  ⚠️ Warning: After changing credentials, you will be logged out and need to log in again with the new credentials.
                </p>
              </div>
            </div>
          </div>
